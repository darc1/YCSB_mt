...
import site.ycsb.db.JdbcMtDBClient;
...
public class DefaultDBFlavor extends DBFlavor {
  ...
  public String createInsertStatement(StatementType insertType, String key) {
    ...
    insert.append(" (" + JdbcMtDBClient.PRIMARY_KEY + "," + insertType.getFieldString() + ")");
  ...
  public String createReadStatement(StatementType readType, String key) {
    ...
    read.append(" WHERE ");
    read.append(JdbcMtDBClient.PRIMARY_KEY);
    read.append(" = ");
    read.append("?");
  ...
  public String createDeleteStatement(StatementType deleteType, String key) {
    ...
    delete.append(" WHERE ");
    delete.append(JdbcMtDBClient.PRIMARY_KEY);
    delete.append(" = ?");
  ...
  public String createUpdateStatement(StatementType updateType, String key) {
    ...
    update.append(" WHERE ");
    update.append(JdbcMtDBClient.PRIMARY_KEY);
    update.append(" = ?");
  ...
  public String createScanStatement(StatementType scanType, String key, boolean sqlserver) {
    ...
    select.append(" WHERE ");
    select.append(JdbcMtDBClient.PRIMARY_KEY);
    select.append(" >= ?");
