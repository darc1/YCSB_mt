 ...
 * @author sudipto
 */
public final class JdbcMtDBCreateTable {
  ...
  private static void createTable(Properties props, String tablename) throws SQLException {
    ...
    String username = props.getProperty(JdbcMtDBClient.CONNECTION_USER);
    String password = props.getProperty(JdbcMtDBClient.CONNECTION_PASSWD, "");
    String url = props.getProperty(JdbcMtDBClient.CONNECTION_URL);
    int fieldcount = Integer.parseInt(props.getProperty(JdbcMtDBClient.FIELD_COUNT_PROPERTY,
        JdbcMtDBClient.FIELD_COUNT_PROPERTY_DEFAULT));
  ...
  public static void main(String[] args) {
    ...
    if (fieldcount > 0) {
      props.setProperty(JdbcMtDBClient.FIELD_COUNT_PROPERTY, String.valueOf(fieldcount));
    }
